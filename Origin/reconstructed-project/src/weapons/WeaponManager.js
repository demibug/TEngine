...
class WeaponManager {
  ...
  remove(weapon){if(!weapon)return false;const owner=weapon.owner;if(owner&&owner.weapon===weapon){if(typeof owner.detachWeapon==='function')owner.detachWeapon();else owner.weapon=null;}weapon.gameOver();return this.weapons.delete(weapon.runtimeId);}
