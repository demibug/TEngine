          ...
          w1_cT: while (z < c[37]) {
            ...
            switch (A) {
              ...
              case 9:
                Object["defineProperty"](b["prototype"], "update", {
                  ["value"](a) {
                    var b = hr,
                      c = "onUpdate";
                    this["onUpdate"](a), this["qk"]["forEach"](b => b["onUpdate"](a, this))
                  },
                  ["enumerable"]: false,
                  ["configurable"]: true,
                  ["writable"]: true
              ...
              case n:
                ...
                break;
              case i:
                Object["defineProperty"](b["prototype"], "hit", {
                  ["value"](a) {
                    var b = hr,
                      c = b[0],
                      d = "Cw";
                    this["eS"]["event"](n4["Uk"], a["id"]), this["Cw"](a), this["qk"]["forEach"](b => b["Cw"](a, this))
                  },
                  ["enumerable"]: false,
                  ["configurable"]: true,
                  ["writable"]: true
                ...
                break;
              case s:
                Object["defineProperty"](b["prototype"], "recover", {
                  ["value"]() {
                    var a = hr,
                      b = a[0],
                      c = a[5],
                      ...
                      l = "Kk",
                      m = "eS";
                    this["zk"] || this["AS"](), this["qk"]["forEach"](a => {
                      a["AS"](this), a["uS"] || a["ES"](this)
                    }), this["Jk"] = !0, this["mS"] = !1, this["ak"] = !0, this["rS"] = !1, this["nS"] = !1, this["Vk"] = !1, this["BS"] = !1, this["zk"] = !1, this["gS"]["Mk"](), this["gS"] = null, this["$k"]["clear"](), this["qk"] = this["qk"]["filter"](a => a["uS"]), this["yS"] != this["Kk"] && (oF["recover"](this["yS"]), this["yS"] = this["Kk"]), this["Xk"] = {
                      ["Gk"]: void 0,
                      ["Hk"]: void 0,
                      ["Wk"]: void 0
                    }, this["lS"](), this["eS"]["event"](n4["Fk"]), this["eS"]["offAll"]()
                  },
                  ["enumerable"]: false,
                  ["configurable"]: true,
                  ["writable"]: true
                ...
                break;
              case w:
                Object["defineProperty"](b["prototype"], "once", {
                  ["value"](a, b, c) {
                    var d = hr,
                      e = "eS",
                      f = "once";
                    return c ? this["eS"]["once"](a, c, b) : this["eS"]["once"](a, b)
                  },
                  ["enumerable"]: false,
                  ["configurable"]: true,
                  ["writable"]: true
                ...
                break;
              case 3:
                Object["defineProperty"](b["prototype"], "pS", {
                  ["value"](a) {
                    var b = hr;
                    return this["qk"]["find"](b => b instanceof a)
                  },
                  ["enumerable"]: false,
                  ["configurable"]: true,
                  ["writable"]: true
                ...
                break;
              case x:
                Object["defineProperty"](b["prototype"], "dispose", {
                  ["value"]() {
                    this["DS"]()
                  },
                  ["enumerable"]: false,
                ...
                Object["defineProperty"](b["prototype"], "on", {
                  ["value"](a, b, c) {
                    var d = hr,
                      ...
                      f = "eS",
                      g = "on";
                    return c ? this["eS"]["on"](a, c, b) : this["eS"]["on"](a, b)
                  },
                  ["enumerable"]: false,
                  ["configurable"]: true,
                  ["writable"]: true
                ...
                Object["defineProperty"](b["prototype"], "SS", {
                  ["value"]() {
                    var a = hr,
                      b = a[0],
                      c = "xS";
                    this["xS"](), this["qk"]["forEach"](a => a["xS"](this)), this["eS"]["event"](n4["Yk"])
                  },
                  ["enumerable"]: false,
                  ["configurable"]: true,
                  ["writable"]: true
