        ! function() {
          ...
          var b = hr,
            ...
            oPP = "configurable",
            oPQ = "writable";
          Object["defineProperty"](a["prototype"], "zb", {
            ["value"]() {
              var a = hr,
                b = a[3],
                c = a[4],
                d = "Ab";
              this["Ab"]["scale"](0, 0), Laya["Tween"]["to"](this["Ab"], {
                ["scaleX"]: 1,
                ["scaleY"]: 1
              }, hu[167])
            },
          ...
          Object["defineProperty"](a["prototype"], "Yb", {
            ["value"](a, b = null) {
              var c = hr,
                d = c[0],
                e = c[5],
                ...
                l = "event";
              let m;
              m = b["ub"](a["containerType"], this["nm"])["getItem"](a["x"], a["y"]);
              if (m) {
                if (this["nm"]) return this["Hb"](), void pp["instance"]()["showTip"]("请先妥善安置农民");
                vc["instance"]()["Nb"](m["id"])
              }
              b["ub"](this["ow"]["containerType"], this["nm"])["removeItem"](this["ow"]["x"], this["ow"]["y"]), oc["instance"]["event"](sS["At"], this["nm"], a["x"], a["y"]), oc["instance"]["event"](sS["Lt"], this["id"])
            },
            ["enumerable"]: false,
            ["configurable"]: true,
            ["writable"]: true
        ...
        a = class extends sl {
          init(a, b) {
            var c = hr,
              ...
              y = "nm",
              z = "th";
            super["init"](a, b), this["wP"] = new Laya["Image"]("resources/img/props/silt_1.png"), this["wP"]["size"](uq["instance"]()["map"]["ye"], uq["instance"]()["map"]["gridHei"]), this["wP"]["zIndex"] = t1["Zn"], Laya["Point"]["TEMP"]["x"] = a ? uq["instance"]()["map"]["ie"]["x"] : uq["instance"]()["map"]["ae"]["x"], Laya["Point"]["TEMP"]["y"] = a ? uq["instance"]()["map"]["ie"]["y"] : uq["instance"]()["map"]["ae"]["y"], oc["instance"]["event"](sS["xt"], this["wP"], Laya["Point"]["TEMP"]["x"], Laya["Point"]["TEMP"]["y"]), this["vP"] = new Laya["Image"]("resources/img/props/silt_2.png"), this["vP"]["size"](d[210], k), this["vP"]["anchorX"] = .5, this["vP"]["anchorY"] = 1, this["vP"]["pos"](d[43], k), this["vP"]["visible"] = !1, this["wP"]["addChild"](this["vP"]), a ? (uq["instance"]()["au"]["Ri"] = !0, vi["instance"]()["LP"]("silt" + this["id"], this["nm"], 3, -.1, !0, up["th"])) : (uq["instance"]()["au"]["Ui"] = !0, vi["instance"]()["LP"]("siltAi" + this["id"], this["nm"], 3, -.1, !0, up["th"])), oc["instance"]["on"](sS["rs"], this, this["_P"])
          }
          gameOver() {
            var a = hr,
              b = a[0],
              ...
              f = "mP",
              g = "id";
            super["gameOver"](), oc["instance"]["off"](sS["rs"], this, this["_P"]), this["wP"]["removeSelf"](), Laya["Tween"]["killAll"](this["vP"]), this["vP"]["removeSelf"](), this["nm"] ? vi["instance"]()["mP"]("silt" + this["id"]) : vi["instance"]()["mP"]("siltAi" + this["id"])
          }
        };
        ! function() {
          "use strict";
          var b = hr;
          Object["defineProperty"](a["prototype"], "_P", {
            ["value"]() {
              var a = hr,
                b = hu,
                c = a[4],
                ...
                l = "create",
                oSh = "alpha";
              this["vP"]["scale"](0, 0), this["vP"]["visible"] = !0, Laya["Tween"]["to"](this["vP"], {
                ["scaleX"]: 1,
                ["scaleY"]: 1
              }, b[45], null, Laya["Handler"]["create"](this, () => {
                this["vP"]["skin"] = "resources/img/props/silt_3.png", Laya["Tween"]["to"](this["vP"], {
                  ["alpha"]: 0
                }, b[81], null, Laya["Handler"]["create"](this, () => {
                  this["vP"]["alpha"] = 1, this["vP"]["visible"] = !1
                }))
              }))
            },
            ["enumerable"]: false,
      ...
      th["instance"]()["register"](10, () => Laya["Pool"]["createByClass"](rU));
      continue
    } else if (ia == b) {
      pc = function() {
        let a;
        a = class extends rD {
          constructor() {
            ...
            var d;
            d = arguments;
            super(...d), this["Wb"] = 3, this["Ub"] = !0, this["nM"] = 4, this["rM"] = !0, this["oM"] = 0, this["lM"] = ["resources/img/props/trainingSpellBurn0.png", "resources/img/props/trainingSpellBurn1.png", "resources/img/props/trainingSpellBurn2.png", "resources/img/props/trainingSpellBurn3.png", "resources/img/props/trainingSpellBurn4.png", "resources/img/props/trainingSpellBurn5.png"]
          }
          init(a, b) {
            super["init"](a, b)
          }
          reset() {
            var a = hr;
            super["reset"](), this["Ab"]["skin"] = "resources/img/props/trainingSpell_1.png"
