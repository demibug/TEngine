...
namespace GameBattle
{
    ...
    public readonly struct BattleOperationResult
    {
        ...
        public static BattleOperationResult Fail(
            ...
            BattleModuleState currentState,
            string diagnosticMessage = null)
            => new BattleOperationResult(errorCode, currentState, diagnosticMessage);
        ...
        public override string ToString()
            => IsSuccess
                ...
                : $"[BattleOperationResult] Failed, Code={ErrorCode}, State={CurrentState}, Msg={DiagnosticMessage}";
    }
}
