...
namespace GameFUI.Tests.PlayMode
{
    ...
    public static class PlayModeTestHarness
    {
        ...
        /// [SetUp] public void SetUp() { PlayModeTestHarness.Cleanup(); GRoot.inst.SetSize(1920, 1080); }
        ...
        /// </para>
        /// </remarks>
        public static FUIModule SetupForShowAsync(FUIOptions options = null, int loadDelayMs = 0)
        {
            // 1. 幂等清空全局状态。
            Cleanup();
        ...
        /// <summary>
        /// 确保 FairyGUI Stage/GRoot 已初始化并设置指定分辨率，供 PlayMode 测试在 EditMode 下使用。
        /// </summary>
        /// <param name="width">逻辑宽度，默认 1920。</param>
        /// <param name="height">逻辑高度，默认 1080。</param>
        /// <remarks>
        ...
        /// 本方法封装 GRoot 初始化逻辑，供测试 SetUp 调用。
        /// </remarks>
        public static void EnsureGRootInitialized(int width = 1920, int height = 1080)
        {
