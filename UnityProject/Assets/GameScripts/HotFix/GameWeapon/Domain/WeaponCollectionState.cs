...
namespace GameWeapon
{
    internal sealed class WeaponCollectionState
    {
        ...
        internal static WeaponCollectionState Create(WeaponCatalog catalog, WeaponProgressSaveData save)
        {
            ...
            var state = new WeaponCollectionState(catalog, fragments, equipped, pending, revision);
        ...
        {
            if (!_catalog.TryGet(weaponId, out WeaponDefinition definition) || !definition.Recyclable)
            {
        ...
        internal WeaponProgressSaveData CreateSaveData()
        {
            ...
            data.fragmentRecords.Sort((a, b) => a.weaponId.CompareTo(b.weaponId));
            data.equipRecords.Sort((a, b) => a.slot.CompareTo(b.slot));
            data.pendingRecords.Sort((a, b) => a.weaponId.CompareTo(b.weaponId));
            return data;
        }
        ...
        {
            return _equipped.ContainsValue(weaponId);
        }
    }
}
